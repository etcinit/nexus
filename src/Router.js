...
var Util = use('Util'),
    ...
    // Include controllers
    ApiController = use('Controllers/ApiController'),
    ApplicationsController = use('Controllers/ApplicationsController'),
    AuthController = use('Controllers/AuthController'),
    FilesController = use('Controllers/FilesController'),
    GrantsController = use('Controllers/GrantsController'),
    IndexController = use('Controllers/IndexController'),
    TokensController = use('Controllers/TokensController'),
    UsersController = use('Controllers/UsersController');
...
class Router {
     ...
     * @param ExpressApp
     * @param Auth
     * @param EnclosureContainer
     */
    constructor(ExpressApp, Auth, EnclosureContainer)
    {
        this.app = ExpressApp;
        this.auth = Auth;
